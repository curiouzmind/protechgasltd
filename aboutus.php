...
<head>
  ...
  <!-- Basic -->
  <title>About Us | Protech Gas Ltd</title>
  <?php include 'header.html' ?>
  
<!-- Start Navigation List -->
<ul class="nav navbar-nav navbar-right">
        <li><a href="index.php"><i class="fa fa-home fa-fw"></i> Home</a></li>
        <li><a class="active" href="aboutus.php">About Us <span class="caret"></span></a> 
          <ul class="dropdown">
      ...
      <div class="row">
            ...
            <div class="col-md-5"> 
              ...
              <div class="touch-slider" data-slider-navigation="true" data-slider-pagination="true">
                <div class="item"><img alt="" src="images/aboutus/1.jpg"></div>
                <div class="item"><img alt="" src="images/aboutus/2.jpg"></div>
                <div class="item"><img alt="" src="images/aboutus/3.jpg"></div>
              </div>
              <!-- End Touch Slider -->
        ...
        <div class="col-md-9">
          <div class="tab-content">
            <div id="mission" class="tab-pane fade active in">
              ...
              <p class="col-md-6">
                <img class="img-responsive" src="images/icons/Icon-mission.png" alt="">
              </p>
              </div>
            </div>
            <div id="vision" class="tab-pane fade in">
              <div class="row">
                ...
                <div class="col-md-6">
                  <img class="img-responsive" src="images/aboutus/Business+vision.png" alt="">
                </div>
              </div>
            </div>
            <div id="services" class="tab-pane fade in">
              <div class="row">
                ...
                <div class="col-md-6">
                  <img class="img-responsive" src="images/aboutus/Services.png" alt="">
                </div>
              </div>                   
            </div>
          </div>
