...
<head>
  ...
  <!-- Basic -->
  <title>Home | Protech Gas Ltd</title>
  <?php include 'header.html' ?>
      <!-- Start Navigation List -->
      <ul class="nav navbar-nav navbar-right">
        <li><a class="active" href="index.php"><i class="fa fa-home fa-fw"></i> Home</a></li>
              ...
              <div class="service-boxed">
                  ...
                  <div class="service-content">
                   ...
                   <div class="text-left">
                    ...
                    <br>
                    <!-- Button in Center -->
                    <p class="text-center"><a href="aboutus.html#services" class="btn-system btn-small border-btn"><i class="icon-brush"></i> Read more</a></p>
                  </div>
              </div>
            </div>
        </div>
      ...
      <div class="hr1 margin-top"></div>
       ...
       <!-- Start Recent Projects Carousel -->
						...
						<div class="portfolio-item item">
							<div class="portfolio-border">
								<div class="portfolio-thumb">
									<a class="lightbox" data-lightbox-type="ajax" href="images/projects/gen-hosp-delta.jpg">
										<div class="thumb-overlay"><i class="fa fa-camera"></i></div>
										<img alt="" src="images/projects/gen-hosp-delta.jpg" />
									</a>
								</div>
            ...
            <div class="portfolio-item item">
              <div class="portfolio-border">
                <div class="portfolio-thumb">
                  <a class="lightbox" data-lightbox-type="ajax" href="images/projects/army-hosp-kaduna.jpg">
                    <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                    <img alt="" src="images/projects/army-hosp-kaduna.jpg" />
                  </a>
                </div>
                <div class="portfolio-details">
                  <a href="#">
            ...
            <div class="portfolio-item item">
              <div class="portfolio-border">
                <div class="portfolio-thumb">
                  <a class="lightbox" data-lightbox-type="ajax" href="images/projects/obi-jackson2.jpg">
                    <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                    <img alt="" src="images/projects/obi-jackson2.jpg" />
                  </a>
                </div>
                <div class="portfolio-details">
                  <a href="#">
            ...
            <div class="portfolio-item item">
              <div class="portfolio-border">
                <div class="portfolio-thumb">
                  <a class="lightbox" data-lightbox-type="ajax" href="images/projects/obi-jackson.jpg">
                    <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                    <img alt="" src="images/projects/obi-jackson.jpg" />
                  </a>
                </div>
                <div class="portfolio-details">
                  <a href="#">
            ...
            <div class="portfolio-item item">
              <div class="portfolio-border">
                <div class="portfolio-thumb">
                  <a class="lightbox" data-lightbox-type="ajax" href="images/projects/navy-calabar.jpg">
                    <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                    <img alt="" src="images/projects/navy-calabar.jpg" />
                  </a>
                </div>
                <div class="portfolio-details">
                  <a href="#">
            ...
            <div class="portfolio-item item">
              <div class="portfolio-border">
                <div class="portfolio-thumb">
                  <a class="lightbox" data-lightbox-type="ajax" href="images/projects/lasuth-lagos.jpg">
                    <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                    <img alt="" src="images/projects/lasuth-lagos.jpg" />
                  </a>
                </div>
                <div class="portfolio-details">
                  <a href="#">
            ...
            <div class="portfolio-item item">
              <div class="portfolio-border">
                <div class="portfolio-thumb">
                  <a class="lightbox" data-lightbox-type="ajax" href="images/projects/fmc-keffi.jpg">
                    <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                    <img alt="" src="images/projects/fmc-keffi.jpg" />
                  </a>
                </div>
                <div class="portfolio-details">
                  <a href="#">
            ...
            <div class="portfolio-item item">
              <div class="portfolio-border">
                <div class="portfolio-thumb">
                  <a class="lightbox" data-lightbox-type="ajax" href="images/projects/gen-hosp-warri.jpg">
                    <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                    <img alt="" src="images/projects/gen-hosp-warri.jpg" />
                  </a>
                </div>
                <div class="portfolio-details">
                  <a href="#">
            ...
            <div class="portfolio-item item">
              <div class="portfolio-border">
                <div class="portfolio-thumb">
                  <a class="lightbox" data-lightbox-type="ajax" href="images/projects/uniben.jpg">
                    <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                    <img alt="" src="images/projects/uniben.jpg" />
                  </a>
                </div>
                <div class="portfolio-details">
                  <a href="#">
            ...
            <div class="projects-carousel touch-carousel">
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/AGSS-Plant.jpg">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/AGSS-Plant.jpg" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/area-alarm.jpg">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/area-alarm.jpg" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  <!-- Start Project Details -->
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/bed-head-panel.jpg">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/bed-head-panel.jpg" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  <!-- Start Project Details -->
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/CEILO-CEILING-MOUNTED.bmp">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/CEILO-CEILING-MOUNTED.bmp" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  <!-- Start Project Details -->
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/copper-fittings.jpg">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/copper-fittings.jpg" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  <!-- Start Project Details -->
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/Gas-station.jpg">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/Gas-station.jpg" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  <!-- Start Project Details -->
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/ID-TAPE.jpg">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/ID-TAPE.jpg" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  <!-- Start Project Details -->
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/medical-gas-cylinder.jpg">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/medical-gas-cylinder.jpg" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  <!-- Start Project Details -->
              ...
              <div class="portfolio-item item">
                <div class="portfolio-border">
                  <!-- Start Project Thumb -->
                  <div class="portfolio-thumb">
                    <a class="lightbox" data-lightbox-type="ajax" href="images/products/nist-tee-assembly.jpg">
                      <div class="thumb-overlay"><i class="fa fa-camera"></i></div>
                      <img alt="" src="images/products/nist-tee-assembly.jpg" />
                    </a>
                  </div>
                  <!-- End Project Thumb -->
                  <!-- Start Project Details -->
     ...
     <div class="our-clients">
        ...
        <div class="clients-carousel custom-carousel touch-carousel" data-appeared-items="4">
          ...
          <div class="client-item item">
            <a href="#"><img src="images/partners/COMEN.jpg" alt="" /></a>
        </div>
        
        <!-- Client 2 -->
        <div class="client-item item">
            <a href="#"><img src="images/partners/dodhys.png" alt="" /></a>
        </div>
        
        <!-- Client 3 -->
        <div class="client-item item">
            <a href="#"><img src="images/partners/gas-arc.bmp" alt="" /></a>
        </div>
        
        <!-- Client 4 -->
        <div class="client-item item">
            <a href="#"><img src="images/partners/gazcon.jpg" alt="" /></a>
        </div>
        
        <!-- Client 5 -->
        <div class="client-item item">
            <a href="#"><img src="images/partners/LM.bmp" alt="" /></a>
        </div>
        
        <!-- Client 6 -->
        <div class="client-item item">
            <a href="#"><img src="images/partners/MATACHANA.png" alt="" /></a>
        </div>
        
        <!-- Client 7 -->
        <div class="client-item item">
            <a href="#"><img src="images/partners/penlon.bmp" alt="" /></a>
        </div>
        
        <!-- Client 8 -->
        <div class="client-item item">
            <a href="#"><img src="images/partners/precision.bmp" alt="" /></a>
        </div>

        <!-- Client 9 -->
        <div class="client-item item">
            <a href="#"><img src="images/partners/vision-air.png" alt="" /></a>
        </div>
